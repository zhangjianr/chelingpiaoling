...
<body>
    <div class="page-container">
     <!-- <form onsubmit="return " class="form form-horizontal" id="form-article-add"> -->
    ...
    <div class="row cl">
        <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
            <button onclick="subimg();" class="btn btn-primary radius" ><i class="Hui-iconfont">&#xe632;</i> 保存</button>
...
function subimg(){
    ...
    // })
    var carousel = $("input[name='img']").val();
    if(carousel == undefined){
        layer.msg('您需要先上传图片');
        return false;
    }
    $.ajax({
        url:"<?php echo U('Index/carouselSave');?>",
        type:'post',
        dataType:'json',
        ...
        success: function(data){
            if(data.msg == 1){
                layer.msg('保存成功');
                window.location.href="<?php echo U('Index/carousel');?>";
            }else{
                layer.msg('您需要先上传');
            }   
        }
