	...
	<form onSubmit="return false;" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="产品标题" name="title">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">新闻简介：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea class="btn-toolbar" data-role="editor-toolbar"
        data-target="#editor" name="content" id="content" placeholder="产品简介"></textarea>
			</div>
		</div>
		<div class="row cl">
