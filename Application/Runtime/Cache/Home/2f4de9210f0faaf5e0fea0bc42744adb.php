...
<!-- saved from url=(0033)http://demo42.zhizhuxiu.com/case/ -->
<html>
<head>
...
<body>
		...
		<div class="wp">
			...
			<div id="nav">
				<ul>
					...
					<li><a href="<?php echo U('Index/product');?>" class="mycur">产品介绍</a></li>
	...
	<div id="bd">
		...
		<div class="wp">
			<div class="tit-i">
				<h3>产品展示</h3>
				<h5><span>Product Center</span></h5>
			</div>
			...
			<ul class="ul-case" id="ul-pc">
				<?php if(is_array($arr)): foreach($arr as $key=>$vo): ?><li>
						<div class="block">
							<div class="pic"><img src="/Public/<?php echo ($vo["image"]); ?>" alt="<?php echo ($vo["title"]); ?>"></div>
							<div class="txt">
								<a href="<?php echo U('Index/productDetails',array('id'=>$vo['id']));?>" target="_blank" style="width:100%;height:100%;display:block;">
									<b></b>
									<div class="pad">
										<h5><?php echo (msubstr($vo["title"],0,5,'utf-8',true)); ?></h5>
										<em></em>
										<h3><?php echo (msubstr($vo["content"],0,6,'utf-8',true)); ?></h3>
									</div>
								</a>
							</div>
						</div>
